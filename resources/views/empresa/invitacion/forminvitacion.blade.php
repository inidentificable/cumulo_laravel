...
@section('content')
    ...
    <form role="form" action="/empresas/crear" method="post">
        <div class="form-group col-md-4">
            ...
            <input type="date" class="form-control" id="fecha_empresa" name="fecha_empresa"
                   value="{{--{{old('fecha_empresa')}}--}}">
        </div>
        <div class="form-group col-md-4">
            <label for="monto_empresa">Monto de la empresa:</label>
            <input type="number" class="form-control" id="monto_empresa" name="monto_empresa"
                   value="{{--{{old('monto_empresa')}}--}}">
        </div>
        <div class="form-group col-md-4">
            <label for="es_aprobada_empresa">Aprobada</label>
            <input type="number" class="form-control" id="es_aprobada_empresa" name="es_aprobada_empresa" min="0"
                   max="1" value="{{--{{old('es_aprobada_empresa')}}--}}">
        </div>
        <div class="form-group col-md-4">
