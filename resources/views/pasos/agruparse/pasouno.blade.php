...
<div class="jumbotron">
    ...
    <a href="{{ url('grupos/empresas/crear') }}" class="btn btn-lg btn-success"><i class="fa fa fa-briefcase"></i> Crear el grupo como Empresa</a>
    @endif
    @if(Auth::user()->es_emprendedor == 1)
    <a href="{{ url('grupos/emprendedores/crear') }}" class="btn btn-lg btn-success"><i class="fa fa fa-child"></i> Crear el grupo como Emprendedor</a>
    @endif
</div>
...
<div class="row marketing">
    ...
    <div class="col-lg-6">
        ...
        <a href="{{ url('empresas/crear') }}" class="btn btn-block btn-primary"><i class="fa fa fa-briefcase"></i> Inscribete como Empresa</a>
    </div>
    @endif
    ...
    <div class="col-lg-6">
        ...
        <a href="{{ url('emprendedores/crear') }}" class="btn btn-block btn-primary"><i class="fa fa fa-child"></i> Inscribete como Emprendedor</a>
    </div>
    @endif    
</div>
<br>
